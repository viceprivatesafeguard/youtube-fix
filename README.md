...
**[viceprivatesafeguard/youtube-fix](https://github.com/viceprivatesafeguard/youtube-fix)** — сборка для Windows 10/11

[**⬇ Скачать последний релиз**](https://github.com/viceprivatesafeguard/youtube-fix/releases/latest)
...
> Если вы наткнулись на что-то вне репозитория `viceprivatesafeguard/youtube-fix`, что распространяется от моего лица — **ФЕЙК**.
...
1. Откройте [**Releases → Latest**](https://github.com/viceprivatesafeguard/youtube-fix/releases/latest) и скачайте **`.rar`** (предпочтительно)
